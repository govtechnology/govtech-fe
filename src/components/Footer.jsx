      ...
      <div className="mx-auto w-full max-w-screen-xl px-[32px] py-6">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0 max-w-[300px]">
            ...
            <a>
              ngubalanDaring merupakan website yang membantu masyarakat Desa
              Ngubalan untuk mengurus administrasi di kantor desa tanpa harus
              datang langsung ketempat dan pengurusannya yang cepat.
            </a>
